...
//
//ID3DX11EffectVariable* CPP_Effect_GetVariableByName(ID3DX11Effect* effect, const char* name);
//
//ID3DX11EffectVariable* CPP_Effect_GetVariableByIndex(ID3DX11Effect* effect, uint32_t index);
//
//ID3DX11EffectVariable* CPP_Effect_GetVariableBySemantic(ID3DX11Effect* effect, const char* semantic);
//
//ID3DX11EffectTechnique* CPP_Effect_GetTechniqueByIndex(ID3DX11Effect* effect, uint32_t index);
//
//ID3DX11EffectTechnique* CPP_Effect_GetTechniqueByName(ID3DX11Effect* effect, const char* name);
//
//ID3DX11EffectPass* CPP_Effect_Technique_GetPassByIndex(ID3DX11EffectTechnique* technique, uint32_t index);
//
//ID3DX11EffectPass* CPP_Effect_Technique_GetPassByName(ID3DX11EffectTechnique* technique, const char* name);
//
//HRESULT CPP_Effect_Pass_Apply(ID3D11DeviceContext* context, ID3DX11EffectPass* pass);
//
//ID3DX11EffectUnorderedAccessViewVariable* CPP_Effect_Variable_AsUAVVariable(ID3DX11EffectVariable* variable);
//
//HRESULT CPP_Effect_Variable_SetUAV(ID3DX11EffectUnorderedAccessViewVariable* variable, ID3D11UnorderedAccessView* uav);
//
//ID3DX11EffectShaderResourceVariable* CPP_Effect_Variable_AsSRVVariable(ID3DX11EffectVariable* variable);
//
//HRESULT CPP_Effect_Variable_SetSRV(ID3DX11EffectShaderResourceVariable* variable, ID3D11ShaderResourceView* srv);
//
//ID3DX11EffectScalarVariable* CPP_Effect_Variable_AsScalar(ID3DX11EffectVariable* variable);
//
//HRESULT CPP_Effect_Variable_SetInt(ID3DX11EffectScalarVariable* variable, int value);
